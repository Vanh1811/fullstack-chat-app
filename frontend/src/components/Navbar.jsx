        ...
        <div className="flex items-center justify-between h-full">
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2.5 hover:opacity-80 transition-all">
              <div className="size-9 rounded-lg bg-primary/15 ring-1 ring-primary/20 flex items-center justify-center">
                <MessageSquare className="w-5 h-5 text-primary" />
              </div>
              <h1 className="text-lg font-semibold tracking-tight">Chatty</h1>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <>
                ...
                <button className="btn btn-ghost btn-sm gap-2" onClick={logout} aria-label="Logout">
